...
function Home() {
	...
	return (
		<Fragment>
						...
						<div className="py-10">
							<div className="w-full mx-auto shadow-lg py-2 absolute  md:top-[-10%] top-[-5%] bg-white rounded-lg">
								...
								<div className="max-w-sm mx-auto shadow-lg  mt-2 rounded-[40px] overflow-hidden  text-sm font-medium">
									<ul class="flex text-sm font-medium text-center  rounded-lg divide-x divide-gray-200 shadow cursor-pointer ">
										<li
											onClick={() => toggleTab(1)}
											className={`inline-block p-2 w-full transition  duration-600 ease-out delay-100 ${
												toggleState === 1 ? 'border-b-[#523970] text-[#523970] border-2' : ''
											}`}
										>
											Book Flight
										</li>
										<li
											className={` inline-block p-2 w-full transition  duration-600 ease-out delay-100 ${
												toggleState === 2 ? 'border-b-[#523970] text-[#523970] border-2' : ''
											}`}
										>
											Flight status
										</li>
										<li
											className={` inline-block p-2 w-full transition  duration-600 ease-out delay-100 ${
												toggleState === 3 ? 'border-b-[#523970] text-[#523970] border-2' : ''
											}`}
										>
											Flight Schedule
										</li>
							...
							<div
								className={`max-w-6xl mx-auto mt-5 flex justify-center flex-col md:flex-row gap-2 flex-wrap ${
									toggleState === 1 ? 'inline-block' : 'hidden'
								}`}
							>
								<div className="ml-2 rounded-md  border flex flex-col md:flex-row gap-2 md:divide-x">
								...
								<div className="md:w-[250px] ml-2 flex flex-col justify-start p-3 md:p-1 border rounded-md">
									<label className="text-[0.8rem]" for="">
										Select Date
									</label>
							...
							<div
								className={`max-w-6xl mx-auto mt-5 flex justify-center flex-col md:flex-row gap-1 flex-wrap ${
									toggleState === 2 ? 'inline-block' : 'hidden'
								}`}
							>
								<div className="ml-2 md:ml-0 rounded-md  border flex flex-col md:flex-row gap-1 md:divide-x">
								...
								<div className="ml-2 md:ml-0 rounded-md  border flex flex-col md:flex-row gap-2 md:divide-x">
								...
								<div className="ml-2 md:ml-0 flex flex-col justify-start p-3 md:p-1 border rounded-md">
									<label className="text-[0.8rem]" htmlFor="">
							...
							<div
								className={`max-w-6xl mx-auto mt-5 flex justify-center flex-col md:flex-row gap-2 flex-wrap  ${
									toggleState === 3 ? 'inline-block' : 'hidden'
								}`}
							>
								<div className="rounded-md  border flex flex-col md:flex-row gap-2 md:divide-x">
									<div className="md:w-[250px] flex flex-col justify-start p-3 md:p-1">
										<label className="text-[0.8rem]" htmlFor="">
											Flying from
										</label>
			...
			<section className="max-w-6xl mx-auto px-5 md:mt-[30%] mt-[130%]"></section>
